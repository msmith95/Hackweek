...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AccountList = __webpack_require__(20);
	...
	var _EditAccount = __webpack_require__(28);
	...
	var _CreateBudget = __webpack_require__(38);
	...
	_index2.default.checkAuth();

	_vue2.default.use(_vueRouter2.default);
	_vue2.default.use(_vueResource2.default);

	if (_index2.default.user.authenticated) {
		_vue2.default.http.get('https://service.michaeldsmithjr.com/api/user?api_token=' + localStorage.getItem('api_token')).then(function (response) {
			_lodash2.default.forEach(response.body.accounts, function (value) {
				_index4.default.accounts[value.id] = value;
				_lodash2.default.forEach(value.expense_items, function (expenseItem) {
					if (_index4.default.expenseItemsSum[expenseItem.category]) {
						_index4.default.expenseItemsSum[expenseItem.category] += expenseItem.spent;
						_index4.default.totalExpense += expenseItem.spent;
					} else {
						_index4.default.expenseItemsSum[expenseItem.category] = expenseItem.spent;
						_index4.default.totalExpense += expenseItem.spent;
					}
				});
				_lodash2.default.forEach(value.income_items, function (incomeItem) {
					_index4.default.incomeItemsSum[incomeItem.name] = incomeItem.income;
					_index4.default.totalIncome += incomeItem.income;
				});
			});

			_index4.default.loaded = true;
		}).catch(function (err) {});
	}

	var Home = { template: '<div><h2>Home</h2><p>Money Manager is an application created by Michael Smith Jr for his CS4830 hack week project.' + 'It allows you to manage your expenses and income.  It provides graphs that help you to see where you are spending your money and ' + 'where you might possibly be able to save money. Lastly it allows you to create a budget for yourself and see just how closly you' + ' follow it.</p></div>' };

	var loggedInGuard = function loggedInGuard(to, from, next) {
		if (_index2.default.user.authenticated) {
			next('/dashboard');
		} else {
			next();
	...
	var router = exports.router = new _vueRouter2.default({
		...
		base: __dirname,
		routes: [{ path: '/', component: Home }, { path: '/login', component: _Login2.default, beforeEnter: loggedInGuard }, { path: '/register', component: _Register2.default, beforeEnter: loggedInGuard }, { path: '/accounts', component: _AccountList2.default, beforeEnter: authGuard }, { path: '/accounts/:accountID', name: 'accounts', component: _Account2.default, beforeEnter: authGuard }, { path: '/accounts/:accountID/editBudget', name: 'editBudget', component: _EditAccount2.default, beforeEnter: authGuard }, { path: '/dashboard', component: _Dashboard2.default, beforeEnter: authGuard }, { path: '/createBudget', component: _CreateBudget2.default, beforeEnter: authGuard }]
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API_URL = 'https://service.michaeldsmithjr.com/api/';
	...
	exports.default = {
	  ...
	  login: function login(context, creds) {
	    ...
	    context.$http.post(LOGIN_URL, creds).then(function (data) {
	      ...
	      _lodash2.default.forEach(data.body.accounts, function (value) {
	        _index2.default.accounts[value.id] = value;
	        _lodash2.default.forEach(value.expense_items, function (expenseItem) {
	          if (_index2.default.expenseItemsSum[expenseItem.category]) {
	            _index2.default.expenseItemsSum[expenseItem.category] += expenseItem.spent;
	            _index2.default.totalExpense += expenseItem.spent;
	          } else {
	            _index2.default.expenseItemsSum[expenseItem.category] = expenseItem.spent;
	            _index2.default.totalExpense += expenseItem.spent;
	          }
	        ...
	        _lodash2.default.forEach(value.income_items, function (incomeItem) {
	          _index2.default.incomeItemsSum[incomeItem.name] = incomeItem.value;
	          _index2.default.totalIncome += incomeItem.value;
	        });
	        console.log("finished parsing");
	        _index2.default.loaded = true;
	      });
	  ...
	  signup: function signup(context, creds) {
	    ...
	    context.$http.post(SIGNUP_URL, creds).then(function (data) {
	      ...
	      _lodash2.default.forEach(err.body, function (value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/Michael/Documents/Development/CS4830/hackweek/site/js/components/Login.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-c90f1316", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-c90f1316", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c90f1316!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Login.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c90f1316!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Login.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  return _vm._h('div', [_vm._h('div', {
	    staticClass: "mdl-shadow--2dp wide-form"
	  }, [_vm._h('form', {
	    attrs: {
	      "action": "#"
	    }
	  }, [_vm._h('p', {
	    staticClass: "hiddenError"
	  }, ["Invalid username or password"]), " ", _vm._h('div', {
	  ...
	  }, ["Password"])]), " ", _vm._h('br'), " ", _vm._h('button', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-c90f1316", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/Michael/Documents/Development/CS4830/hackweek/site/js/components/Register.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-05b21247", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-05b21247", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-05b21247!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Register.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-05b21247!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Register.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  ...
	  }, ["Confirm Password"])]), " ", _vm._h('br'), " ", _vm._h('button', {
	    staticClass: "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent",
	    on: {
	      "click": function($event) {
	        $event.preventDefault();
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-05b21247", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/Michael/Documents/Development/CS4830/hackweek/site/js/components/AccountList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-669f7f77", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-669f7f77", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] AccountList.vue: functional components are not supported and should be defined in plain js files using render functions.")}
	...
	exports.default = {
		...
		methods: {
			saveAccount: function saveAccount() {
				var vm = this;
				this.$http.post("https://service.michaeldsmithjr.com/api/createAccount?api_token=" + localStorage.getItem('api_token'), this.account).then(function (response) {
			...
			deleteAccount: function deleteAccount(id) {
				...
				this.$http.post("https://service.michaeldsmithjr.com/api/deleteAccount?api_token=" + localStorage.getItem('api_token'), params).then(function (response) {
					if (response.ok) {
						_vue2.default.delete(vm.accountList, params.accountID);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  return _vm._h('div', [_vm._h('table', {
	    ...
	    }, [_vm._s(account.name)])]), " ", _vm._h('td', [_vm._s(account.balance)]), " ", _vm._h('td', [_vm._h('i', {
	    ...
	    staticClass: "mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored fab",
	    on: {
	      "click": function($event) {
	        _vm.addAccount()
	      }
	  ...
	  return _vm._h('thead', [_vm._h('tr', [_vm._h('th', {
	    staticClass: "mdl-data-table__cell--non-numeric"
	  }, ["Account Name"]), " ", _vm._h('th', ["Current Projected Balance"]), " ", _vm._h('th')])])
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-669f7f77", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/Michael/Documents/Development/CS4830/hackweek/site/js/components/Account.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-792abb8e", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-792abb8e", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-792abb8e!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Account.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-792abb8e!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Account.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
					data: function data() {
									return {
													...
													categoryList: ["Groceries", "Gas", "Out to Eat", "Food", "Insurance", "Car", "House", "Other Loans", "Utilities", "Other"],
													totalIncome: 0,
													totalExpense: 0
									};
					},
					...
					methods: {
									deleteIncome: function deleteIncome(id) {
													...
													var index = _lodash2.default.findIndex(this.income, function (o) {
																	return o.id == id;
													});
													var params = { accountID: this.$route.params.accountID, incomeID: id };
													this.$http.post("https://service.michaeldsmithjr.com/api/deleteIncomeItem?api_token=" + localStorage.getItem('api_token'), params).then(function (response) {
																	console.log(index);

																	_this.income.splice(index, 1);
																	_this.createAccountIncomeChart();
																	_this.createAccountExpenseVsIncomeChart();
																	var snackbar = document.querySelector('#toast');
									...
									saveEditedExpenseItem: function saveEditedExpenseItem() {
													...
													this.$http.post('https://service.michaeldsmithjr.com/api/updateExpense?api_token=' + localStorage.getItem('api_token'), params).then(function (response) {
																	_this2.expenses.splice(_this2.expenseItem.index, 1, item);
																	_this2.createAccountExpenseChart();
																	_this2.createAccountExpenseVsIncomeChart();
																	_this2.expenseItem.index = 0;
																	_this2.expenseItem.value = 0;
																	_this2.expenseItem.name = '';
									...
									addExpenseItem: function addExpenseItem() {
													...
													if (index != -1) {
																	(function () {
																					var item = _this3.expenses[index];
																					item.spent += _this3.expenseItem.value;
																					var vm = _this3;
																					item.remaining = item.budgeted - item.spent;
																					var params = { accountID: item.account_id, expenseID: item.id, spent: item.spent, remaining: item.remaining };
																					_this3.$http.post('https://service.michaeldsmithjr.com/api/updateExpense?api_token=' + localStorage.getItem('api_token'), params).then(function (response) {
																									_this3.expenses.splice(index, 1, item);
																									_this3.createAccountExpenseChart();
																									_this3.createAccountExpenseVsIncomeChart();
																									_this3.expenseItem.value = 0;
																									_this3.expenseItem.category = 0;
																									var snackbar = document.querySelector('#toast');
									...
									addIncome: function addIncome() {
													...
													this.$http.post("https://service.michaeldsmithjr.com/api/createIncomeItem?api_token=" + localStorage.getItem('api_token'), params).then(function (response) {
																	_this4.incomeItem.name = '';
																	_this4.incomeItem.value = 0;
																	_this4.income.push(item);
																	_this4.createAccountIncomeChart();
																	_this4.createAccountExpenseVsIncomeChart();
																	$('[data-modal-close="addIncome"]').click();
													}).catch(function (err) {
																	console.log(err);
													});
									},
									createAccountExpenseChart: function createAccountExpenseChart() {
													...
													var vm = this;
													vm.totalExpense = 0;
													_lodash2.default.forEach(this.expenses, function (value) {
																	expenseData.addRow([value.category, value.spent]);
																	vm.totalExpense += value.spent;
													});
													var options = { 'title': 'Breakdown of expenses by category',
																	'width': 400,
																	'height': 300 };
													var totalExpenses = new google.visualization.PieChart(document.getElementById('accountExpenses'));
													totalExpenses.draw(expenseData, options);
									},
									createAccountIncomeChart: function createAccountIncomeChart() {
													var incomeData = new google.visualization.DataTable();
													incomeData.addColumn('string', 'Source');
													incomeData.addColumn('number', 'Amount');
													var vm = this;
													vm.totalIncome = 0;
													_lodash2.default.forEach(this.income, function (value) {
																	incomeData.addRow([value.name, value.income]);
																	vm.totalIncome += value.income;
													});
													var options = { 'title': 'Breakdown of income by source',
																	'width': 400,
																	'height': 300 };
													var totalIncome = new google.visualization.PieChart(document.getElementById('accountIncome'));
													totalIncome.draw(incomeData, options);
									},
									createAccountExpenseVsIncomeChart: function createAccountExpenseVsIncomeChart() {
													var data = new google.visualization.DataTable();
													data.addColumn('string', 'Type');
													data.addColumn('number', 'Amount');
													data.addRows([['Expenses', this.totalExpense], ['Income', this.totalIncome]]);
													var options = { 'title': "Expenses vs Income",
																	'width': 400,
																	'income': 300 };
													var chart = new google.visualization.PieChart(document.getElementById('accountExpensesVsIncome'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  ...
	  }, ["Edit Budget"])])]), " ", _vm._m(0), " ", _vm._h('div', {
	    staticClass: "mdl-grid"
	  }, [_vm._h('div', {
	  ...
	  }, [_vm._m(1), " ", _vm._h('tbody', [_vm._l((_vm.expenses), function(item) {
	    return _vm._h('tr', [_vm._h('td', {
	      staticClass: "mdl-data-table__cell--non-numeric"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        deleteItem: function deleteItem(id) {
	            ...
	            var params = { accountID: this.$route.params.accountID, expenseID: id };
	            this.$http.post("https://service.michaeldsmithjr.com/api/deleteBudgetItem?api_token=" + localStorage.getItem('api_token'), params).then(function (response) {
	                if (response.ok) {
	                    console.log(index);
	        ...
	        updateBudget: function updateBudget() {
	            ...
	            var params = { accountID: this.$route.params.accountID, budgetItems: this.categories.concat(this.tempCategories) };
	            var vm = this;
	            this.$http.post("https://service.michaeldsmithjr.com/api/updateBudget?api_token=" + localStorage.getItem('api_token'), params).then(function (response) {
	                vm.categories = vm.categories.concat(response.body);
	                _storage2.default.accounts[_this2.$route.params.accountID].expense_items = vm.categories;
	                console.log(response);
	                vm.$router.go(-1);
	            }).catch(function (err) {
	                console.log(err);
	        ...
	        addBudgetCategory: function addBudgetCategory() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  return _vm._h('div', [_vm._h('table', {
	    staticClass: "mdl-data-table mdl-js-data-table mdl-shadow--2dp horiz-center"
	  }, [_vm._m(0), " ", _vm._h('tbody', [_vm._l((_vm.categories.concat(_vm.tempCategories)), function(category) {
	    return _vm._h('tr', [_vm._h('td', {
	      staticClass: "mdl-data-table__cell--non-numeric"
	...
	exports.default = {
	    ...
	    methods: {
	        createExpenseChart: function createExpenseChart() {
	            ...
	            expenseData.addColumn('string', 'Category');
	            expenseData.addColumn('number', 'Spent');
	            _lodash2.default.forEach(_storage2.default.expenseItemsSum, function (value, key) {
	                expenseData.addRow([key, value]);
	            });
	            var options = { 'title': 'Breakdown of expenses by category',
	                'width': 400,
	                'height': 300 };
	            var totalExpenses = new google.visualization.PieChart(document.getElementById('totalExpenses'));
	            totalExpenses.draw(expenseData, options);
	        },
	        createIncomeChart: function createIncomeChart() {
	            var incomeData = new google.visualization.DataTable();
	            incomeData.addColumn('string', 'Source');
	            incomeData.addColumn('number', 'Amount');
	            _lodash2.default.forEach(_storage2.default.incomeItemsSum, function (value, key) {
	                incomeData.addRow([key, value]);
	            });
	            var options = { 'title': 'Breakdown of income by source',
	                'width': 400,
	                'height': 300 };
	            var totalIncome = new google.visualization.PieChart(document.getElementById('totalIncome'));
	            totalIncome.draw(incomeData, options);
	        },
	        createIncomeExpenseChart: function createIncomeExpenseChart() {
	            var data = new google.visualization.DataTable();
	            data.addColumn('string', 'Type');
	            data.addColumn('number', 'Amount');
	            data.addRows([['Expenses', _storage2.default.totalExpense], ['Income', _storage2.default.totalIncome]]);
	            var options = { 'title': "Expenses vs Income",
	                'width': 400,
	                'income': 300 };
	            var chart = new google.visualization.PieChart(document.getElementById('expensesVsIncome'));
	            chart.draw(data, options);
	        }
	    },
	    mounted: function mounted() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  ...
	  return _vm._h('div', [_vm._h('h1', ["Dashboard"]), " ", _vm._h('p', ["The dashboard shows data that has been aggregates from all of the accounts you have added to the system.\n        It allows you to see everything at a glance before looking at everything account by account"]), " ", _vm._h('div', {
	    staticClass: "mdl-grid"
	  }, [_vm._h('div', {
	    staticClass: "mdl-cell mdl-cell--4-col",
	    attrs: {
	...
	exports.default = {
	    ...
	    methods: _defineProperty({
	        ...
	        saveBudget: function saveBudget() {
	            ...
	            var vm = this;
	            this.$http.post('https://service.michaeldsmithjr.com/api/createBudget?api_token=' + localStorage.getItem('api_token'), params).then(function (response) {
